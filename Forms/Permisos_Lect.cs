...
public partial class PermisosLect : Form
{
    ...
    private void Cargarpermisos(string name)
    {
        ...
        foreach (var indice in perm.Select(permiso => checkedListBox1.FindStringExact(permiso))
                     .Where(indice => indice != ListBox.NoMatches)) checkedListBox1.SetItemChecked(indice, true);
    }
