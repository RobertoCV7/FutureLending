...
namespace FutureLending.Forms
{
    partial class Administrador_Acceso
    {
        ...
        private void InitializeComponent()
        {
            ...
            label1 = new Label();
            TextBoxUsuario = new TextBoxPersonalizado();
            label2 = new Label();
            label3 = new Label();
            TextBoxContra = new TextBoxPersonalizado();
            ...
            TextBoxUsuario.TextChanged2EventHandler += TextBoxUsuario_TextChanged2EventHandler;
            // 
            // label2
            // 
        ...
        private TextBoxPersonalizado TextBoxUsuario;
        private Label label2;
        private Label label3;
        private TextBoxPersonalizado TextBoxContra;
