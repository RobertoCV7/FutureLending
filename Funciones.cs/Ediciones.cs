...
namespace FutureLending.Funciones.cs
{
    internal class Ediciones
    {
        ...
        "Correo", "Tipo_de_pago", "Liquidacion_Intencion", "Quita"
            ...
            var query = columnNames.Aggregate("UPDATE lista2 SET ", (current, columnName) => current + $"{columnName} = @{columnName}, ");
        ...
        public bool EditarLista3(string[] datos)
        {
            ...
            const string query = $"UPDATE {nombreTabla} SET Promotor=@NuevoPromotor, Nombre_Completo =@NuevoNombre, Credito_Prestado = @NuevoCredito,Pagare = @NuevoPagare, Calle = @NuevaCalle, Colonia = @NuevaColonia, Num_int = @NuevoNumInt, Num_ext = @NuevoNumExt, Telefono = @NuevoTelefono, Correo = @NuevoCorreo, Tipo_de_Resolucion = @NuevoTipoResolucion, Resolucion_Demanda = @NuevoResolucionDemanda, Importe= @NuevoImporte  WHERE Nombre_Completo = @Nombre";
        ...
        public bool EditarListaLiquidados(string[] datos)
        {
            ...
            const string query = $"UPDATE {nombreTabla} SET Promotor=@NuevoPromotor, Nombre_Completo=@NuevoNombre, Credito_Prestado = @NuevoCredito, Fecha_Inicio = @NuevaFechaInicio, Calle = @NuevaCalle, Colonia = @NuevaColonia, Num_int = @NuevoNumInt, Num_ext = @NuevoNumExt, Telefono = @NuevoTelefono, Correo = @NuevoCorreo, Forma_Liquidacion = @NuevoFormaLiquidacion WHERE Nombre_Completo = @Nombre";
