...
namespace FutureLending.Funciones.cs
{
    internal class ExportarExcel
    {
        ...
        private readonly string[] nombresLista1 = {"PROMOTOR","NOMBRE", "CREDITO","PAGARE", "FECHA INICIO","FECHA TERMINO" ,"INTERESES", "MONTO TOTAL",
                              "CALLE", "COLONIA", "NÚM. INT.", "NÚM. EXT.", "TELÉFONO", "CORREO",
                              "TIPO DE PAGO", "MONTO RESTANTE"};

        private readonly string[] nombresLisat2 = {"PROMOTOR","NOMBRE", "CREDITO", "MONTO RESTANTE","PAGARE",
                                "CALLE", "COLONIA", "NÚM. INT.", "NÚM. EXT.", "TELÉFONO", "CORREO",
        ...
        private readonly string[] nombresListasLiq = {"PROMOTOR","NOMBRE", "CREDITO", "FECHA INICIO",
