...
namespace FutureLending.Funciones.cs
{
    ...
    {
        static readonly LecturaBaseDatos A = new LecturaBaseDatos();
        #region Dar Acceso
        ...
        public static bool AgregarUsuario(string nuevoUsuario, string nuevaContraseña)
        {
            ...
            try
            {
                ...
                const string insertarUsuarioQuery = "INSERT INTO Usuarios (Usuario, Contraseña, lista1, lista2, lista3, liquidados) VALUES (@Usuario, @Contraseña, @Lista1, @Lista2, @Lista3, @Liquidados)";
        ...
        {
            using var connection = A.Conector();
            const string query = "UPDATE Usuarios SET Usuario = @NuevoUsuario, Contraseña = @NuevaContraseña WHERE Usuario = @Usuario";
            try
            {
